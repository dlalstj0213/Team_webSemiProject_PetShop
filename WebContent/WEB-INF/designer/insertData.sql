...
insert into MEMBER values('test1@naver.com','test1', '1234','00002', '서울시 마포구 공덕동', '01009876543', null);
...
--제품--
insert into PRODUCT values(0001, '포펫 K50', 1290000, 20);
insert into PRODUCT values(0002, '포펫 K100', 1690000, 20);
insert into PRODUCT values(0003, '포펫 K200', 1590000, 20);
insert into PRODUCT values(0004, '포펫 K300', 2690000, 20);
insert into PRODUCT values(0005, '포펫 W400', 3190000, 20);

--배송--
insert into DELIVER values(0001, 2020, 2000, SYSDATE+1);

--주문--
insert into ORDER_DETAIL values(ORDER_DETAIL_SEQ.nextval, 'test3@naver.com', 1, 0001, SYSDATE, '서울시 마포구 신수동', '01002020101', '신용카드', 1, 1290000, 0, null);
insert into ORDER_DETAIL values(ORDER_DETAIL_SEQ.nextval, 'test3@naver.com', 1, 0002, SYSDATE, '서울시 마포구 신수동', '01002020101', '신용카드', 2, 3380000, 0, null);
insert into ORDER_DETAIL values(ORDER_DETAIL_SEQ.nextval, 'test3@naver.com', 1, 0003, SYSDATE, '서울시 마포구 신수동', '01002020101', '신용카드', 1, 1590000, 0, null);

--장바구니--
insert into CART values(CART_SEQ.nextval, 'test1@naver.com', 0001);
insert into CART values(CART_SEQ.nextval, 'test1@naver.com', 0002);
insert into CART values(CART_SEQ.nextval, 'test1@naver.com', 0003);
insert into CART values(CART_SEQ.nextval, 'test2@naver.com', 0001);
